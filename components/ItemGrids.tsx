    ...
    <s-section>
      <s-stack direction="block" gap="base">
        ...
        <div style={{ overflowX: 'auto' }}>
          <s-table variant="table" style={{ minWidth: '1600px' }}>
            <s-table-header-row>
              ...
              return (
                <s-table-row key={line.rowId}>
                                ...
                                <s-stack direction="block" gap="small">
                                  ...
                                  <s-choice-list
                                    ...
                                    onChange={(event: Event) => {
                                      ...
                                      if (selected) {
                                        void selectProduct(line.rowId, selected);
                                      }
                                    }}
                                    onInput={(event: Event) => {
                                      const [selectedId] = eventValues(event);
                  ...
                  <s-table-cell className="hs-code-cell">
                    <s-text-field
                      className="hs-code-field"
                      value={line.hsCode}
                      disabled={readOnly}
                      onInput={(event: Event) =>
                        updateLine(line.rowId, (current) => ({ ...current, hsCode: eventValue(event) }))
                      }
                    />
                  </s-table-cell>
